...
class Nova(BaseModel):
    ...
    name_norm: str = Field(..., description="RA [deg] ICRS J2000")
    data_table_id: Optional[int] = Field(None, description="RA [deg] ICRS J2000")
    ...
    obs_year: int = Field(..., description="Year in which nova was discovered")
    ...
    max_mag_band: Optional[str] = Field(None, description="Filter of maximum magnitude")
